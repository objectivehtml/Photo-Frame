...
(function($) {
	...
	/*
	PhotoFrame.Class  = function(_default, options) {
	...
	PhotoFrame.Photo = PhotoFrame.Class.extend(obj, options, {
		init: function() {
			
		}
	});
	
	PhotoFrame.Photo = function(obj, options) {
		var $obj     = $(obj);
		var _default = {
			callbacks: {
				init: function() {},
		...
		var t = new PhotoFrame.Class(_default, options);
	...
	PhotoFrame.ProgressBar = function(obj, progress, options) {
		var $obj     = $(obj);		
		var _default = {
			callbacks: {
				init: function() {},
